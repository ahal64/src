...
class TasksController extends AppController
{
     ...
     */
    public function add($standid = null)
    {
		$standards = $this->loadModel('Standards');
		$standardlist = $standards->find('list')->select(['standardid','name']);
        ...
        $this->set(compact('task','standid','standardlist'));
        $this->set('_serialize', ['task']);
    }
